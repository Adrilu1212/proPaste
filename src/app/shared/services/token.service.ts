...
export class TokenService {
  ...
  private REFRESH_TOKEN = 'RFRESH_TOKEN';

  http = inject(HttpClient);
  resfrescado : boolean = false;
  ...
  public decodeToken():any{ // decodifica el token y lo develve
